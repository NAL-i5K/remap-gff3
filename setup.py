...
setup(
    ...
    description='Python programs for updating gff3 coordinates to new assembly versions.',  # Required
    ...
    url='https://github.com/NAL-i5K/remap-gff3',  # Optional
    ...
    project_urls={  # Optional
        'Source': 'https://github.com/NAL-i5K/remap-gff3',
    },
)
