...
if __name__ == '__main__':
    ...
    Quick start:
    python %(prog)s -a example_file/alignment.gff3 -t_fa example_file/target.fa -q_fa example_file/query.fa -tmp_ID -g example_file/example1.gff3 example_file/example2.gff3
    """))
